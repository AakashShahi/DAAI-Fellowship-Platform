  ...
  if (selectedTrack && !canAccessQuiz(user, track.quizSlug)) {
    return (
      <div className="app-home">
        <section className="mx-auto mt-7 max-w-5xl rounded-lg border border-red-200 bg-red-50 p-6 text-red-700 shadow-[0_18px_45px_-28px_rgba(15,23,42,0.35)]">
    ...
    <div className="app-home">
      <section className="mx-auto mt-7 max-w-5xl">
        <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-[0_18px_45px_-28px_rgba(15,23,42,0.35)]">
          <div className="mt-1 grid gap-6 lg:grid-cols-[1fr_280px] lg:items-start">
            <div>
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                {track.skills.map((skill) => (
                  <span
                    key={skill}
                    className="rounded-full bg-indigo-50 px-3 py-1 text-xs font-black text-[#475569]"
                  >
                    {skill}
                  </span>
                ))}
            ...
            <aside className="rounded-lg border border-slate-200 bg-[#f8fafc] p-5">
              <p className="text-xs font-black uppercase tracking-wide text-[#4f46e5]">
                Progress
              </p>
              <p className="mt-2 text-4xl font-black text-[#0f172a]">0%</p>
              <div className="mt-4 h-3 overflow-hidden rounded-full bg-slate-200">
                <span className="block h-full w-0 rounded-full bg-[#4f46e5]" />
              </div>
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-[1fr_300px]">
          ...
          <aside className="rounded-lg border border-slate-200 bg-white p-6 shadow-[0_18px_45px_-28px_rgba(15,23,42,0.35)]">
            <p className="text-xs font-black uppercase tracking-wide text-[#4f46e5]">
              Next Step
            </p>
            <h2 className="mt-2 text-2xl font-black text-[#0f172a]">
            ...
            <div className="mt-5">
              <Link
                to={track.quizPath}
                className="block rounded-md bg-[#4f46e5] px-5 py-3 text-center text-sm font-black text-white transition hover:bg-[#4338ca]"
              >
                Take Quiz
              </Link>
            </div>
